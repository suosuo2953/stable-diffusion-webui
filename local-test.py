...
if __name__ == '__main__':
    payload = {
        "prompt": "The clear sky is a stunning sight to behold, with its deep blue hue and a bright, warm sun shining down on everything below. The clouds are nowhere to be seen, allowing the sun's rays to illuminate the world in all its glory. The air is crisp and fresh, and a gentle breeze carries the sweet scent of blooming flowers. It's a perfect day to be outdoors, basking in the warmth of the sun and enjoying the natural beauty of the world around us.",  # extra networks also in prompts
        "negative_prompt": "",
        "seed": 1,
        "steps": 20,
        "width": 512,
